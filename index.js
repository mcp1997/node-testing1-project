...
function findLargestInteger(integers) {
  // ✨ implement
  let [result] = Object.values(integers[0])
  integers.reduce((acc, obj) => {
    const [prevValue] = Object.values(acc)
    const [currValue] = Object.values(obj)
    if(currValue > prevValue && currValue > result) {
      result = currValue
    }
    return obj
  })
